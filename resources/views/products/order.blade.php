                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 text-center text-lg-left mt-lg-0 mt-md-4 ">
                                            ...
                                            <div class="mg-10">
                                                ...
                                                <a class="btn btn-primary btn-sm" href="./gio-hang/buynow/{{$products->id}}">Mua ngay</a>
                                                <a class="btn btn-primary btn-sm " href="./gio-hang/add/{{$products->id}}"><svg class="svg-inline--fa fa-shopping-cart fa-w-18" aria-hidden="true" data-prefix="fa" data-icon="shopping-cart" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
