...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:8888/websua/css/register.css">
</head>
...
<body id="signUp">
    <div class="register-content widget mt-3">
        ...
        <div class="widget-body">
            ...
            @endif
            <form method="post" action="dang-ki" enctype="multipart/form-data">
                @csrf
    ...
    <script src="http://localhost:8888/websua/public/vendor/jquery/jquery.min.js"></script>
    <script src="http://localhost:8888/websua/public/js/bootstrap/bootstrap.bundle.min.js"></script>
    <script src="http://localhost:8888/websua/js/shipping.js"></script>
    <script src="http://localhost:8888/websua/js/register.js"></script>
</body>
